...
$original_filename = $_SESSION['dec_fname'];

$down_fname = str_replace(".txt","_Decrypted.txt",$original_filename);

$_SESSION['dec_filename'] = $down_fname;

$files = fopen("files joined/$down_fname", 'w');
...
$files = file_get_contents("files joined/$down_fname");
